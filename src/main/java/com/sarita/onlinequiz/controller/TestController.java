...
import com.sarita.onlinequiz.service.test.TestService;
...
public class TestController {
    ...
    public ResponseEntity<?> getAllQuestions(@PathVariable Long id){
        try{
                return new ResponseEntity<>(testService.getAllQuestionByTestId(id),HttpStatus.OK);
        }catch(Exception e){
            return new ResponseEntity<>(e.getMessage(),HttpStatus.BAD_REQUEST);
        }
    ...
    public ResponseEntity<?> getAllTestResultsForUser(@PathVariable Long id){
        try{
